<template>
    <div>
        <div className="max-w-3xl mx-auto px-4 py-10">
            <div>
                <div
                    className="bg-white rounded-lg p-10 flex items-center shadow justify-between"
                >
                    <div>
                        <svg
                        ...
                        <h2
                            className="text-2xl mb-4 text-gray-800 text-center font-bold"
                        >
                            Registration Success
                        </h2>
                        <div className="text-gray-600 mb-8">
                            Thank you. We have sent you an email to
                            demo@demo.test. Please click the link in the message
                ...
                <div className="py-10">
                    <div>
                        <div className="mb-5 text-center">
                            ...
                            <div
                                className="mx-auto w-48 text-gray-500 text-xs text-center mt-1"
                            >
                    ...
                    <div >
                        <div className="mb-5">
                            ...
                            <p className="mt-5 text-gray-600">
                                Inspired from dribbble shot: Exploration for a
                                password strength meter by
                                <a
        ...
        {/* Bottom Navigation */}
        <div
            className="fixed bottom-0 left-0 right-0 py-5 bg-white shadow-md"
