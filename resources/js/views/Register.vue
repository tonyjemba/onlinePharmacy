  ...
  -->
    <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <form class="mt-8 space-y-6" @submit.prevent="submitRegForm" method="POST">
                ...
                <div class="rounded-md shadow-sm -space-y-px">
                    <div>
                        ...
                        <input id="name" name="username" type="text" required=""
                            ...
                            placeholder="Username" v-model="credentials.name" />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input id="password_confirmation" name="password" type="password"
                            ...
                            placeholder="Confirm Password" v-model="credentials.password_confirmation" />
                    </div>
                </div>
                <div class="text-sm">
