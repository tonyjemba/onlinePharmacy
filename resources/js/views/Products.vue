                    ...
                    <div class="bg-white rounded flex items-center w-full p-3 shadow-sm border border-gray-200">
                        <div class="flex flex-col w-full">
                            ...
                            <div class="flex flex-row w-full">
                                <button @click="getSearchedData" class="outline-none focus:outline-none">
                                ...
                                <input type="search" name="" id="" placeholder="search for items"
                                    class="w-full pl-4 text-sm outline-none focus:outline-none bg-transparent"
                                    v-model="state.itemName" v-on:input="getSearchedData" />
                                <div class="select">
                            ...
                            <div class="pt-4 flex flex-col" v-if="state.show === true">
                                <div>
                                    <div class="text-1xl md:text-2xl text-black">
                                    ...
                                    <div class="grid justify-center md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-7 my-10">
                                        <div v-for="product in searchedProducts" :key="product.id">
                                            <DashboardItemCard :product_name="
    product.product_name
" :descprition="
    product.descprition
" :image_url="product.image_url" :price="product.price"
                                                :updated_at="product.updated_at" :buttons="false"
                                ...
                                <div class="pt-4">
                                    ...
                                    <div class="grid justify-center md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-7 my-10">
                                        <div v-for="product in searchedServices" :key="product.id">
                                            <DashboardItemCard :product_name="
    product.product_name
" :descprition="
    product.descprition
            ...
            <div class="grid justify-center md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-7 my-10">
                <div v-for="product in products" :key="product.id">
                    <DashboardItemCard :product_name="product.product_name" :descprition="product.descprition"
                        ...
                        :buttons="false" @view="viewProduct(product.id)" />
                </div>
            </div>
        </div>
        <div>
            ...
            <div class="grid justify-center md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-7 my-10">
                <div v-for="service in services" :key="service.id">
                    <DashboardItemCard :product_name="service.service_name" :descprition="service.descprition"
                        :image_url="service.image_url" :price="service.price" :updated_at="service.updated_at"
                        :buttons="false" @view="viewProduct(service.id)" />
                </div>
            </div>
        </div>
    </div>
